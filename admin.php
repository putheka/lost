...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="admin.php"class="text-primary disabled"><i class="fas fa-user"></i> Total Users (<?php echo $tu; ?>)</a></li>
...
<div class="content" id="content">
    <button class="btn btn-dark d-block d-md-none mb-3" id="sidebarCollapse"><i class="fas fa-bars"></i></button>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><?php echo $tu; ?></h3>
                        <a href="admin.php" class="btn btn-primary disabled">View</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
