...
<div class="container mt-4">
    <h1 class="mb-4 text-center">All Found Items</h1>
    
    <!-- Search Form -->
    <form method="GET" action="View_all_found_items.php" class="mb-4">
    ...
    <div class="row">
        <?php echo get_found_item_cards($keyword, $category, $date, $location); ?>
    </div>
</div>
