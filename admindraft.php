...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="admindraft.php" class="text-primary disabled"><i class="fas fa-file-alt"></i> Drafted Posts (<?php echo $td; ?>)</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3><?php echo $td; ?></h3>
                        <a href="admindraft.php" class="btn btn-primary disabled">View</a>
                    </div>
                </div>
            </div>
        </div>
